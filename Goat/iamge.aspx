<%@ Page Language="C#" AutoEventWireup="true" CodeFile="iamge.aspx.cs" Inherits="iamge" %>
...
<body>
        ...
        <div class="menu-list">
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu" id="products">
              ...
              <li style="background-color: #020203"><asp:HyperLink ID="HyperLink7" runat="server" Target="_top">照片</asp:HyperLink></li>
            </ul>
    ...
    <div>
         <div class="row" style="height: 1700px; background-color: #F0F0F0; margin-left: 300px; margin-top: 66px; width: 78%">
      <div class="row" style="background-color: #FFFFFF; height: 1700px; width: 65%">
        <div class="row" style="margin-top: 50px"></div>
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">照片能让您的空间栩栩如生</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">添加至少1张房客可以进入的区域的照片。您随时都可以回来添加更多照片。</font></h5>
          </div>
        </div>
        <hr width="80%"/>
        <div class="row">
        ...
        <asp:Button ID="Button1" runat="server" Text="添加" OnClick="Button1_Click" /><br />
        <table id="Table1" runat="server" enableviewstate="true">
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-8">
            <h2><asp:Button ID="Button2" class="btn btn-warning btn-block" runat="server" Text="下一步" OnClick="save_Click" /></h2>
          </div>
        </div>
      </div>
    </div>
