<%@ Page Language="C#" AutoEventWireup="true" CodeFile="housePublish7.aspx.cs" Inherits="housePublish7" %>
        ...
        <div class="menu-list">
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu" id="service">
              ...
              <li style="background-color: #020203"><asp:HyperLink ID="HyperLink9" runat="server" Target="_top">预定</asp:HyperLink></li>
      ...
      <div class="row" style="background-color: #FFFFFF; height: 900px; width: 65%">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">选择您的房客如何预订的方式</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">通过选择方式准备好接待房客。</font></h5>
          </div>
        </div>
        <hr width="80%"/>
        <div class="row" style="height: 300px">
          <div class="col-md-4 col-md-offset-1" style="height: 300px; border: 1px solid #FF606E; padding-right: 0px">
            <div style="height: 30px"></div>
            <div class="row">
              <div class="col-md-10">
                <h5><font color="#6c6c6c">评价每一个预订申请</font></h5>
              </div>
            </div>
            <hr width="90%"/>
            <div class="row">
              <div class="col-md-12">
                <ul style="padding-left: 15px">
                  <li><h5><font color="#6c6c6c">房客发送预订申请。</font></h5></li>
                  <li><h5><font color="#6c6c6c">24小时内接受或拒绝。</font></h5></li>
                </ul>
              </div>
            </div>
            <div style="height: 15px"></div>
            <div class="row">
              <div class="col-md-6 col-md-offset-2" style="padding-right: 0px;">
                <h2><asp:Button ID="this1" runat="server" Text="选择这个"  class="btn btn-warning btn-block" OnClick="this1_Click" /></h2>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-md-offset-2" style="height: 300px; border: 1px solid #FF606E; padding-left: 0px">
            <div style="height: 30px"></div>
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <h5><font color="#6c6c6c">房客即时预订</font></h5>
              </div>
            </div>
            <hr width="90%"/>
            <div class="row">
              <div class="col-md-11 col-md-offset-1">
                <ul style="padding-left: 15px">
                  <li><h5><font color="#6c6c6c">设置谁可以预订和什么时间预订的控制。</font></h5></li>
                  <li><h5><font color="#6c6c6c">房客不需要准可就可以预订。</font></h5></li>
                </ul>
              </div>
            </div>
            <div style="height: 0px"></div>
            <div class="row">
              <div class="col-md-6 col-md-offset-3" style="padding-right: 0px;">
                <h2><asp:Button ID="this2" runat="server" Text="选择这个"  class="btn btn-warning btn-block" OnClick="this2_Click" /></h2>
              </div>
            </div>
          </div>
        </div>
