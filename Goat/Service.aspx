        ...
        <div class="menu-list">
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu" id="products">
              ...
              <li style="background-color: #020203"><asp:HyperLink ID="HyperLink6" runat="server" Target="_top">额外服务</asp:HyperLink></li>
      ...
      <div class="row" style="background-color: #FFFFFF; height: 900px; width: 65%">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">向旅行者提供您的服务</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">要想吸引更多的房客，请您提供更过人性化的服务，提高房客的租房体验。</font></h5>
          </div>
        </div>
        <hr width="80%"/>
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">额外服务</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="engage" runat="server" Text="接站/送站" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="brorrowCar" runat="server" Text="租车（家用车、船、自行车）" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="foodGuide" runat="server" Text="美食导游" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="shopGuide" runat="server" Text="购物导游" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="spotGuide" runat="server" Text="景点导游" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="translate" runat="server" Text="翻译人员" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="ticket" runat="server" Text="票务代理" AutoPostBack="false" />
                </label>
              </div>
          	</div>
            <div class="form-group checkbox">
              <div class="checkbox">
                <label>
                    <asp:CheckBox ID="foodMake" runat="server" Text="私人餐饮定制" AutoPostBack="false" />
                </label>
              </div>
          	</div>
          </div>
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-8" style="margin-top: -15px">
            <h2><asp:Button ID="nextService" runat="server" Text="下一步"  class="btn btn-warning btn-block" OnClick="nextService_Click"/></h2>
          </div>
        </div>
