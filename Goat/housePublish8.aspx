<%@ Page Language="C#" AutoEventWireup="true" CodeFile="housePublish8.aspx.cs" Inherits="housePublish8" %>
        ...
        <div class="menu-list">
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu" id="service">
              ...
              <li style="background-color: #020203"><asp:HyperLink ID="HyperLink10" runat="server" Target="_top">日历</asp:HyperLink></li>
      ...
      <div class="row" style="background-color: #FFFFFF; height: 900px; width: 65%">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">让旅行者知道他们可以预订哪些日期</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">准确的日历是出租最重要的第一步。</font></h5>
          </div>
        </div>
        <hr width="80%"/>
        <div class="row" style="margin-top: 50px"></div>
        <div class="row">
          <div class="col-md-10 col-md-offset-1" style="height: 250px; border: 1px solid #ff606e">
            <div class="row" style="height: 100%">
              <div class="col-md-5" style="height: 100%; background-color: #F0F0F0">
                <div class="row" style="height: 130px"></div>
                <div class="row">
                  <div class="col-md-11 text-center">
                    <h4><font color="#6c6c6c">一次</font></h4>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-10 col-md-offset-1 text-center">
                    <h5><font color="#6c6c6c">只是一段时间的房东。</font></h5>
                  </div>
                </div>
              </div>
              <div class="col-md-7" style="height: 100%">
                ...
                <div class="row">
                  <div class="col-md-10 col-md-offset-1">
                    <h4><font color="#6c6c6c">房客什么时候可以预订？</font></h4>
                  </div>
                </div>
                <div class="row" style="height: 10px"></div>
                <div class="row">
                  <div class="col-md-5 col-md-offset-1">
                    <h5><font color="#6c6c6c">开始日期</font></h5>
                  </div>
                  <div class="col-md-5 col-md-offset-1">
                    <h5><font color="#6c6c6c">结束日期</font></h5>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-5 col-md-offset-1">
                    <h5><input type='text' runat="server" class="form-control" id='datetimepickerStart'/></h5>
                    <script type="text/javascript">
                      $(function () {
                          $('#datetimepickerStart').datetimepicker({ format: 'DD/MM/YYYY' });
                      });
                    </script>
                  </div>
                  <div class="col-md-5 col-md-offset-1">
                    <h5><input type='text' runat="server" class="form-control" id='datetimepickerStop'/></h5>
                    <script type="text/javascript">
                      $(function () {
                          $('#datetimepickerStop').datetimepicker({ format: 'DD/MM/YYYY' });
                      });
                    </script>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-8">
            <h2><asp:Button ID="next8" runat="server" Text="下一步"  class="btn btn-warning btn-block" OnClick="next8_Click"/></h2>
          </div>
        </div>
      </div>
    </div>
