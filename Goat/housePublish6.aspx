<%@ Page Language="C#" AutoEventWireup="true" CodeFile="housePublish6.aspx.cs" Inherits="housePublish6" %>
        ...
        <div class="menu-list">
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu" id="service">
              <li style="background-color: #020203"><asp:HyperLink ID="HyperLink8" runat="server" Target="_top">价格</asp:HyperLink></li>
      ...
      <div class="row" style="background-color: #FFFFFF; height: 800px; width: 65%">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2><font color="#6c6c6c">为您的房源设置一个每晚价格</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">您可以设置一个能体现您的房源、便利设施和好客之道的价格。</font></h5>
          </div>
        </div>
        <hr width="80%"/>
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2 style="font-size: 120%"><font color="#ff606e">基础价格</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-2 col-md-offset-1" style="padding-top: 9px;">
            <h5><font color="#6c6c6c">基础价格</font></h5>
          </div>
          <div class="col-md-7">
            <h5><asp:TextBox ID="price" AutoPostBack="false" runat="server" Height="31px" Width="345px"></asp:TextBox></h5>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7 col-md-offset-3">
            <h5 style="font-size: 60%; margin-top: -5px;"><font color="#6c6c6c">货币类型为人民币</font></h5>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h2 style="font-size: 120%"><font color="#ff606e">长期住宿价格</font></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-1">
            <h5><font color="#6c6c6c">提供折扣，吸引房客预订更长时间的住宿。</font></h5>
          </div>
        </div>
        <div class="row">
          <div class="col-md-2 col-md-offset-1" style="padding-top: 9px;">
            <h5><font color="#6c6c6c">每周折扣</font></h5>
          </div>
          <div class="col-md-7">
            <h5><asp:TextBox ID="cutWeek" AutoPostBack="false" runat="server" Height="31px" Width="345px"></asp:TextBox></h5>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7 col-md-offset-3">
            <h5 style="font-size: 60%; margin-top: -5px;"><font color="#6c6c6c">%</font></h5>
          </div>
        </div>
        <div class="row">
          <div class="col-md-2 col-md-offset-1" style="padding-top: 9px;">
            <h5><font color="#6c6c6c">每月折扣</font></h5>
          </div>
          <div class="col-md-7">
            <h5><asp:TextBox ID="cutMonth" AutoPostBack="false" runat="server" Height="31px" Width="345px"></asp:TextBox></h5>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7 col-md-offset-3">
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-8">
            <h2><asp:Button ID="next6" runat="server" Text="下一步"  class="btn btn-warning btn-block" OnClick="next6_Click"/></h2>
          </div>
        </div>
